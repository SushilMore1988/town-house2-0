...
class BrowseCoWorkSpaceController extends Controller
{
	public function index($viewType){
		...
		if($viewType == 'map'){
			...
			return view('front.cowork.browse.map-view',compact('coWorkSpaces','currentButton', 'countries'));
		}else{
			$currentButton="list_view";
			return view('front.cowork.browse.list-view',compact('coWorkSpaces','currentButton', 'countries'));
		}
	}
