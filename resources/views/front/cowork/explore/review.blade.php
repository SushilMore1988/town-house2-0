...
@auth
	@if($coWorkSpace->user_id != Auth::id())
		...
		@endif
		@endforeach --}}
		@elseif(empty($coWorkSpace->experienceOfCoWorkSpaces()->where('user_id',Auth::user()->id)->where('cws_id',$coWorkSpace->id)->first()) && $coWorkSpace->cwsBookings()->where('user_id', Auth::id())->first())
