<div class="tab-pane pt-3 flex-column  marketing-tab @if($current_tab == 'marketing') active @endif" id="marketing" role='tabpanel'>
	...
	<div class="d-flex align-items-end align-text-bottom">
		<button type="button" class="mt-5 w-100 marketing-btn-next btn btn-success n-bold f-9 rounded-0 ml-2 w-100">Save</button>
	</div>
</div>