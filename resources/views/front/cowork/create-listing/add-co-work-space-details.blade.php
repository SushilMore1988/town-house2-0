			...
			<div class="justify-content-center align-self-center d-flex flex-column">
				<div class="row ">
					...
					<div class="col-md-9 col-sm-12 px-lg-5" >
						...
						<p class="r-lightItalic f-9 text-body" id="dynamic-message">Let us know more about your space to get the best TH2.0 reviews and have an attractive page for providing information to the users.</p> 
					</div>
				</div>
				<div class="sub-division mt-md-3">
					@livewire('co-work.edit', ['cws' => $coWorkSpace], key($coWorkSpace->id))
				</div>				
			</div>
		</div>
	</section>
...
@section('js')	
	...
	<script>
		window.livewire.on('updateActiveSection', param => {
			$('.'+param['value']).find('a').trigger('click');
		});
	</script>
	{{-- @jquery --}}
	...
	@include('front.cowork.create-listing.scripts.photo-script')
	@include('front.cowork.create-listing.scripts.image-cropper-script')
	@include('front.cowork.create-listing.scripts.about-script')
	@include('front.cowork.create-listing.scripts.facilities-script')
	@include('front.cowork.create-listing.scripts.package-script')
	@include('front.cowork.create-listing.scripts.opening-hours-script')
	@include('front.cowork.create-listing.scripts.size-script')
	@include('front.cowork.create-listing.scripts.pricing-script')
	@include('front.cowork.create-listing.scripts.terms-condition-script')
	@include('front.cowork.create-listing.scripts.co-work-space-script')
	@include('front.cowork.create-listing.scripts.email-verification-script')
