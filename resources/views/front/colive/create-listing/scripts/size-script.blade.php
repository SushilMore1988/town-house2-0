		...
		if(byNumber == 1){	
			...
			var template = `<div class="col-lg-8 col-xl-8 mb-3">
							<div class="d-flex align-items-center">
								<div class="w-75">
									<input type="text" name="privateOfficeName_`+totalPrivateOffices+`" class="form-control size-percent common-field-input ml-2 w-100 privateOfficeName" placeholder="" value="Office Name `+addZero+totalPrivateOffices+`" />
								</div>
								<div class="w-25 ml-2">
							  		<input type="text" name="privateOfficeCapacity_`+totalPrivateOffices+`" class="form-control size-percent common-field-input ml-2 w-100 number privateOfficeCapacity" placeholder="" />
							  	</div>
							</div>
						</div>`;
