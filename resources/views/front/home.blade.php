                            ...
                            @foreach($coWorkSpaqaces as $coWorkSpace)
                                @if($coWorkSpace->progress_percent != 100)
                                    ...
                                    @if($i > 3)
                                        @break
                                    @endif
                                    <a class="dropdown-item border-top-0" href="{{route('co-work-space.edit',$coWorkSpace->slug)}}">
                                        <div class="media">
