...
@section('content')
	<div class="pb-2 border-bottom">
		<div class="form-row">
			<h1 class="col-6">Algorithm Listing</h1>
			...
			@foreach($algorithms as $algorithm)
				<tr data-url="patient-details.html">
					<th scope="row">{{$loop->index +1}}</th>
			      	...
			      	<td> {{$algorithm->range_from}} </td>
			      	<td> {{$algorithm->range_to}} </td>
			      	<td><a href="{{route('admin.algorithm.edit',$algorithm->id)}}"><i class="fas fa-pencil-alt"></i></a></td>
				</tr>
			@endforeach
		</tbody>
	</table>
