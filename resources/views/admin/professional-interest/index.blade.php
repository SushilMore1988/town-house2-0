    ...
    <div class="modal-dialog introModule">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Create New Professional Interest</h4>
                <button type="button" class="close text-dark" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('admin.professional-interests.store')}}">
                    @csrf
                    <div class="form-row">
                        <label>Name</label>
...
<div class="modal" id="editModal">
    <div class="modal-dialog introModule">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Professional Interest</h4>
                <button type="button" class="close text-dark" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('admin.professional-interests.update')}}">
                    @csrf
