	    	...
	    	<div class="row">
	      		<div class="col-12">
	        		<div class="card">
				        ...
				        <div class="card-body">
				            {!! Form::model($term, ['route'=> ['admin.about.term.update',$term->id]]) !!}
					  			<div class="row">
						  			...
						  			<div class="form-group col-md-12 py-2">
						  				...
						  				@if ($errors->has('category')) <span class="invalid-feedback d-block" role="alert"><strong>{{ $errors->first('category') }}</strong></span> @endif
						  			</div>
						  			<div class="form-group col-md-12 py-2">
						  				<div class="clearfix">
