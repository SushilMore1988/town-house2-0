...
@section('content')
	...
	{!! Form::model('clsAmenityValue', [ 'route' =>['admin.amenities.update', $clsAmenityValue->id],'files' => 'true' ] ) !!}
        @method('put')
			...
			<div class="col-lg-8 col-sm-12">
					<div class="col-sm-12 col-lg-12">
						<div class="form-group">
                            ...
                            {!! Form::select('amenity_category', $clsAmenityCategories, $clsAmenityValue->cls_amenity_category_id, ['class' => 'form-control', 'required']) !!}
					...
					<div class="col-sm-12 col-lg-12">
						<div class="form-group">
							...
							{!! Form::text( 'amenity_name', $clsAmenityValue->value, [ 'id' => 'amenity_name', 'required', 'class' => 'form-control']) !!}	
					...
					<div class="col-sm-12 col-lg-12">
                        ...
                        @if(!empty($clsAmenityValue->icon_image))
                            <img src="{{url('img/amenity/'.$clsAmenityValue->icon_image)}}" style="max-height:100px;max-width:100px;">
                        @endif
					</div>
					<div class="col-sm-12 col-lg-12">
						<div class="form-group">
							<label class="w-100">Rating Value:</label><br />
							{!! Form::text( 'rating_category', $clsAmenityValue->rating_category, [ 'id' => 'rating_category', 'required', 'class' => 'form-control']) !!}	
