...
@section('content')
	...
	<div class=" pt-3 pb-2 border-bottom">
		<div class="form-row py-4">
			<h1 class="col-6">Create New Amenity Category</h1>
	...
	{!! Form::open([ 'route' => [ 'admin.amenity-category.store' ] ] ) !!}
		<div class="form-box mt-3 py-4">
			<div class="col-lg-8 col-sm-12">
					<div class="col-sm-12 col-lg-12">
						<div class="form-group">
							<label class="w-100">Amenity Category Name:</label><br />
							{!! Form::text( 'name',null, [ 'id' => 'name', 'required' =>'required', 'class' => 'form-control']) !!}	
				  				@if ($errors->has('name')) 
